<footer class="relative w-full flex flex-col text-white">
    <div class="w-full relative leading-[0]">
        <img draggable="false" src="/images/misc/dark-pink-waves.svg" alt="background waves"
            class="h-auto absolute z-1 top-0 left-0 w-full">
        <img draggable="false" src="/images/misc/slate-waves.svg" alt="front waves" class="relative h-auto w-full z-10">
    </div>
            ...
            <div class="flex flex-col gap-4 items-center md:items-end">
                <div class="w-full md:w-fit flex flex-col items-center md:items-start">
                    ...
                    <nav class="flex flex-col gap-3">
                        ...
                        <a href="/dashboard" class="hover:underline text-lg transition-colors">Dashboard</a>
                    </nav>
                </div>
            </div>
        </div>
