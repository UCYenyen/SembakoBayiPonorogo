<form action="{{ url('/admin-project') }}" method="GET" class="flex gap-2 w-full">
    ...
    <button type="submit"
        class="px-4 md:px-6 py-3 bg-[#3F3142] hover:bg-[#5C4B5E] text-white rounded-lg transition-colors duration-200 text-sm md:text-base whitespace-nowrap">
        Search
    </button>
    @if (request('search'))
