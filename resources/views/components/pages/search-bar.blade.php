<form action="{{ url($route) }}" method="GET" class="md:flex gap-2 w-full {{ $extraClass }}">
    ...
    <button type="submit"
        class="hidden md:inline-block px-4 md:px-6 py-2 bg-[#3F3142] hover:bg-[#5C4B5E] text-white rounded-lg transition-colors duration-200 text-sm md:text-base whitespace-nowrap">
