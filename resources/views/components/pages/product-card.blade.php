<a href="{{ route('product.show', $product ?? 0) }}" class="flex flex-col items-center justify-center bg-[#F4F5FF] rounded-xl shadow-lg p-3 sm:p-4 md:p-6 gap-3 sm:gap-4 md:gap-5 w-full hover:shadow-xl transition-shadow">
