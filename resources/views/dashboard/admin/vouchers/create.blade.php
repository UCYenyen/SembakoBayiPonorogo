    ...
    <main class="bg-[#FFF3F3] text-[#3F3142] flex items-center justify-center min-h-screen py-12">
        <div class="w-full max-w-2xl mx-auto px-4">
            <div class="bg-white rounded-lg shadow-lg p-8">
                <h1 class="text-3xl font-bold mb-6">Create New Voucher</h1>
                ...
                <form action="{{ route('admin.vouchers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p class="text-sm text-blue-800">
                            <strong>Info:</strong> This voucher will be available for users who have accumulated the required points.
                        </p>
                    </div>
