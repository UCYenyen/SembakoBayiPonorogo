                                    ...
                                    @if ($transaction->no_resi)
                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <p class="font-bold text-[#3F3142] font-mono">{{ $transaction->no_resi }}
                                                </p>
                                                <button onclick="copyToClipboard('{{ $transaction->no_resi }}', this)"
                                                    class="text-gray-400 hover:text-[#3F3142] transition-colors">
