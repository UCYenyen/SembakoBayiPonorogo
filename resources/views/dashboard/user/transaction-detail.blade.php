                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex gap-4">
                                <div class="flex flex-col items-center">
                                    <div class="w-10 h-10 rounded-full {{ $transaction->isProcessing() || $transaction->isShipped() || $transaction->isDelivered() || $transaction->isCompleted() ? 'bg-[#3F3142]' : 'bg-gray-300' }} flex items-center justify-center text-white">
