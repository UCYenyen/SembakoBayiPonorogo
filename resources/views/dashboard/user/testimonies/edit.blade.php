        ...
        <div class="w-[80%] mx-auto">
            ...
            <form action="{{ route('user.testimonies.update', $testimony) }}" 
                ...
                <div class="mb-4">
                    ...
                    <div id="media-preview" class="flex flex-wrap gap-3 mb-2"></div>
                    <label for="media-upload" class="cursor-pointer flex items-center justify-center w-24 h-24 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100">
                        <svg class="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                        <input id="media-upload" type="file" class="hidden" multiple accept="image/*,video/*">
                    </label>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updatePreview() {
                ...
                filesArray.forEach((file, idx) => {
                    ...
                    let el = file.type.startsWith('image/') ? document.createElement('img') : document.createElement('video');
                    el.src = url;
                    el.className = 'w-24 h-24 object-cover rounded-lg border';
